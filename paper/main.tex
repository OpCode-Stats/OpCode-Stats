...
language and biological sequences.  We present \emph{OpCode-Stats}\footnote{\url{https://github.com/OpCode-Stats/OpCode-Stats}}, an open-source toolkit (inspired by computational biology techniques applied to DNA sequences, hence the name \emph{Binary DNA}) that applies
...
4.65~million instructions, we characterise opcode frequency distributions,
...
\begin{itemize}
  ...
  \item \emph{Coreutils-system} (39 binaries after inode deduplication):
...
scales to 39 binaries spanning 11 functional categories.
...
\midrule
Within-proj.  & 75  & $0.501$ & $18{,}162$ & $<0.0001$ & $0.506$ \\
Within-comp.  & 60  & $0.544$ & $14{,}040$ & $<0.0001$ & $0.532$ \\
Between       & 300 & $0.582$ & ---        & ---       & ---    \\
\bottomrule
\end{tabular}
\end{table}
...
we apply the full pipeline to the 39-binary coreutils-system corpus and
...
\begin{tabular}{@{}lcc@{}}
\toprule
\textbf{Metric} & \textbf{Smoke (15)} & \textbf{Coreutils (39)} \\
\midrule
Instructions (M)         & 3.12  & 4.65  \\
Vocabulary $|\mathcal{V}|$   & 293   & 320   \\
MLE $\hat{\alpha}$       & 1.444 & 1.447 \\
KS goodness-of-fit       & 0.114 & 0.119 \\
$h_r(1)$ (bits)          & 3.99  & 4.00  \\
$h_r(5)$ (bits)          & 2.16  & 2.20  \\
$\Delta h_r$ (1→5)       & 1.82  & 1.80  \\
\zlib{} ratio (real)     & 0.223 & 0.224 \\
\zlib{} ratio (shuffled) & 0.361 & 0.366 \\
\zlib{} ratio (random)   & 0.672 & 0.682 \\
